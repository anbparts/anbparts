...
// DESATIVADO temporariamente: a API de visitas do ML parou de registrar dados
// (confirmado no painel do proprio ML). Reativar descomentando a rota abaixo
// + o fetch e o card 'Visitas hoje (ML)' no dashboard (frontend/app/page.tsx).
