...
import { confSeparacaoRouter } from './routes/conf-separacao';
import { confTextoPecaRouter } from './routes/conf-texto-peca';
import { curvaAbcRouter } from './routes/curva-abc';
...
app.use('/conf-separacao', confSeparacaoRouter);
app.use('/conf-texto-peca', confTextoPecaRouter);
app.use('/curva-abc', curvaAbcRouter);
