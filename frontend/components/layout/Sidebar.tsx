...
function SidebarIcon({ name, active, size = 16 }: { name: string; active: boolean; size?: number }) {
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    clipboard: <svg {...common}><rect x="9" y="2" width="6" height="4" rx="1" /><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><path d="M12 11h4" /><path d="M12 16h4" /><path d="M8 11h.01" /><path d="M8 16h.01" /></svg>,
